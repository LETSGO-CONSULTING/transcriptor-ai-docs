...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          // editUrl: 'https://github.com/your-org/live-translation-docs/tree/main/',
        },
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Live Translation App. Built with Docusaurus.`,
    },
    prism: {
